...
if cl == 'I':
    ...
    df = pd.read_csv(r'/Users/saikrishnapaila/Desktop/Hospital_dept/Patient.csv')
    pat1 = df[df['Gender'] == 'Male']
    pat1.to_csv(r'/Users/saikrishnapaila/Desktop/Hospital_dept/Male_Patient.csv', index=False)
    print(pd.read_csv(r'/Users/saikrishnapaila/Desktop/Hospital_dept/Male_Patient.csv'))
    pat2 = df[df['Gender'] == 'Female']
    pat2.to_csv(r'/Users/saikrishnapaila/Desktop/Hospital_dept/Female_Patient.csv', index=False)
    print(pd.read_csv(r'/Users/saikrishnapaila/Desktop/Hospital_dept/Female_Patient.csv'))
